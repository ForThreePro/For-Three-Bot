...
// DATOS PAGO
const pagosData = {
  PEN: [{nombre:'Yape', num:'936994155'}, {nombre:'Prex', num:'12249975'}],
  MXN: [{nombre:'Global66', num:'@CRIROJ1855'}],
  CLP: [{nombre:'Global66', num:'@CRIROJ1855'}],
  COP: [{nombre:'Global66', num:'@CRIROJ1855'}]
};
...
function enviarWsp(){
  ...
  let msg=`Hola Yallico, pagué el plan ${document.getElementById('nomPlan').innerText} a ${metodoSel}. Adjunto captura.`;
...
// MÚSICA + PARTÍCULAS igual que antes
